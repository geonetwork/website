...
Documentation for the stable release version **2.10.4** of GeoNetwork opensource.

* `User manual <manuals/2.10.4/eng/users/index.html>`_ - The manual is a comprehensive guide to all aspects of using GeoNetwork opensource.
...
* `Widgets API Reference <manuals/2.10.4/eng/widgets/index.html>`_ - The manual is for those who want to develop custom GUI using javascript widgets library.

* Javadocs:
	* `GeoNetwork <manuals/2.10.4/eng/developer/apidocs/geonetwork/index.html>`_ - GeoNetwork javadocs.

	* `Jeeves <manuals/2.10.4/eng/developer/apidocs/jeeves/index.html>`_ - Jeeves javadocs.
